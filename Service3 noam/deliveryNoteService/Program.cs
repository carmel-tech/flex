...
//        const string Prefix = "http://+:80/dashboard/";
     ...
     public static deliveryNoteService svc = null;
        /// </summary>
       ...
       /* private void Application_Startup(object sender, StartupEventArgs e)
        ...
        static void GetContextCallback(IAsyncResult ar)
        {
            ...
            //dammaged
            s = s.Replace("%NumOfDammaged%", svc.NumOfDammaged.ToString());
           
          //  Page.ClientScript.RegisterStartupScript( "CallMyFunction", "MyFunction()", true);
           
            
                s = s.Replace("%dateOfDammaged1%", svc.DateOfDammaged1.ToString());
                ...
                int ho = dd.Hour;
                    ...
                    try
                    {
                        ...
                        string ss = svc.DateOfDammaged3.ToString();
                       
                       // ss = ss.Substring(0, ss.Length - (ss.Length - ss.LastIndexOf("A")));
                       // ss = ss.Trim();
                        ss = ss.Substring(ss.IndexOf(" "));
                        
                        
                        string hour=ss.Substring(0,ss.IndexOf(":"));
                        int newho = Convert.ToInt32(hour);
                        ss = ss.Substring(ss.IndexOf(":"));
                        string minutes = ss.Substring(1, ss.LastIndexOf(":")-1);
                        int newminutes = Convert.ToInt32(minutes);
                        min=min-7;
                        if (newho == ho && newminutes > min)
                        {
                            s = s.Replace("%inv_fnt_color11%", "#FF0000;");
                            s = s.Replace("%inv_fnt_color3%", "#FF0000;");
                        }
                        else
                        {
                            s = s.Replace("%inv_fnt_color11%", "#000000;");
                            s = s.Replace("%inv_fnt_color3%", "#000000;");
                        }
                    ...
                    try
                    {
                        ...
                        string ss = svc.DateOfDammaged2.ToString();
                      ...
                      //  ss = ss.Substring(0, ss.Length - (ss.Length - ss.LastIndexOf("A")));
                       // ss = ss.Trim();
                        ...
                        {
                            s = s.Replace("%inv_fnt_color11%", "#FF0000;");
                            s = s.Replace("%inv_fnt_color2%", "#FF0000;");
                        }
                        else
                        {
                            s = s.Replace("%inv_fnt_color11%", "#000000;");
                            s = s.Replace("%inv_fnt_color2%", "#000000;");
                        }
                    ...
                    try
                    {
                        ...
                        string ss = svc.DateOfDammaged1.ToString();
                      ...
                      //  ss = ss.Trim();
                        ...
                        {
                            s = s.Replace("%inv_fnt_color11%", "#FF0000;");
                            s = s.Replace("%inv_fnt_color1%", "#FF0000;");
                        }
                        else
                        {
                            s = s.Replace("%inv_fnt_color11%", "#000000;");
                            s = s.Replace("%inv_fnt_color1%", "#000000;");
                        }
                  ...
                  /*   try
                     {
                        if (Convert.ToDateTime(svc.DateOfDammaged3.ToString()) > DateTime.Now.AddMinutes(-5))
                        {
                            s = s.Replace("%inv_fnt_color11%", "#FF0000;");
                            s = s.Replace("%inv_fnt_color3%", "#FF0000;");
                        }
